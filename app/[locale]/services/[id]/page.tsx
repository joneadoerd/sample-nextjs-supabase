...
import { ServiceComments } from "@/components/services/service-comments";
...
const mockCurrentUser = {
  ...
  role: "user", // Change to "user" to test regular user functionality
};
            ...
            <div className="bg-card rounded-lg border p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {format(new Date(service.user.createdAt), "MMM d, yyyy")}
                  </p>
                </div>
              </div>
