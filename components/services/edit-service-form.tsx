...
export default function EditServiceForm({ service }: EditServiceFormProps) {
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground mt-2">You don't have permission to edit this service.</p>
          </div>
        </CardContent>
        <CardFooter>
  ...
  const removeImage = (index: number) => {
    ...
    const newImageIndex = index - service.images.length
  ...
  const onSubmit = async (data: ServiceFormValues) => {
    try {
      ...
      const newImageUrls = images.map((_, index) => `https://example.com/image-${index}.jpg`)

      // Combine existing images that weren't removed with new ones
      const finalImageUrls = [...imageUrls.filter((_, i) => i < service.images.length), ...newImageUrls]
      ...
      toast.error("There was an error updating your service. Please try again.")
    } finally {
            ...
            <FormField
              ...
              render={() => (
                <FormItem>
                  ...
                  <FormDescription>Upload images for your service (max 5 images).</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe your service" className="min-h-32" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>As an admin, you can reassign this service to another user</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
